 ...
 */
public class StripesStruct extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(StripesStruct.class);
...
protected static class MyReducer extends Reducer<Text, HMapStFW, Text, HMapStFW> {
    ...
    protected void setup(Context context) throws IOException{
      ...
      //  /u6/h225liu/cs489//sidedata/part-r-00000
  ...
  public int run(String[] argv) throws Exception {
    ...
    LOG.info("Tool name: " + StripesStruct.class.getSimpleName());
    ...
    job.setJobName(StripesStruct.class.getSimpleName());
    job.setJarByClass(StripesStruct.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new StripesStruct(), args);
  }
  //end of class
}