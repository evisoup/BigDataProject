 ...
 */
public class PairsStruct extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(PairsStruct.class);
...
protected static class MyReducer extends
  ...
  public int run(String[] argv) throws Exception {
    ...
    LOG.info("Tool name: " + PairsStruct.class.getSimpleName());
    ...
    job.setJobName(PairsStruct.class.getSimpleName());
    job.setJarByClass(PairsStruct.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new PairsStruct(), args);
  }
  //end of class
}