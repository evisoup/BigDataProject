package ca.uwaterloo.cs.evisoup.assignment7;
...
public class HBaseBuildIndex extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(HBaseBuildIndex.class);
  ...
  public int run(String[] argv) throws Exception {
    ...
    LOG.info("Tool: " + HBaseBuildIndex.class.getSimpleName());
    ...
    job.setJobName(HBaseBuildIndex.class.getSimpleName());
    job.setJarByClass(HBaseBuildIndex.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new HBaseBuildIndex(), args);
  }
}
